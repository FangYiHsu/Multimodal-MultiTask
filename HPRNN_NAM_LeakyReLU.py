...
from models.LeakyReLU.ConvGRU import ConvGRUCell
from models.LeakyReLU.CNNCell import EncoderCNNCell, DecoderCNNCell
from models.LeakyReLU.IntegrationCell import IntegrationCell,GuidingCell
from models.LeakyReLU.RefinementCell_NAM_ch_sp import RefinementCell
...
class HPRNN(nn.Module):
    ...
    def autoencoder(self, x, seq_len, future_step, h_t, c_t, h_t2, c_t2, h_t3, c_t3, h_t4, c_t4, h_tl, c_tl): # m_t, m_t2, m_t3, m_t4):
        ...
        # decoder
        # print("h_tl_cat_encoder", h_tl_cat_encoder.shape)
        for n in range(future_step//6):  
            ...
            # print("guiding_out.size(0)",guiding_out.size(0))
